...
What's new :
- Fix Location overlay not working
- New testing for overlap bugs. If you experience an overlap, please enable in advance the diagnostics badges, and try launching a few times, you will see a letter A/B/C, please report a picture if you see an overlap with one, or if one seems to always work ok, this may require a few tests. Please report it on discord/github after enabling 
- Various fixes
