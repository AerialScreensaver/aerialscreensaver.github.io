...
- Reenable missing tvOS 26 source
- Fix location overlay not showing on first video in some shared configurations
- Clarify what the shuffle tooltip do (they shuffle at playlist end)
- For more info on V4 changes, check : https://aerialscreensaver.github.io/ 
