...
What's new :
- Fix auto-pause not correctly behaving on screen reconnect
- Fix wallpaper mode not correctly handling some disconnect/reconnect scenarios where macOS changes the UUID of the screen
