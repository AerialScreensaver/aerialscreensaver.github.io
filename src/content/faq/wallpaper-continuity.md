---
question: What is Wallpaper Continuity?
category: Wallpaper
order: 65
---
...
**4.1 beta:** the native Wallpaper Extension replaces Wallpaper Continuity — Aerial *is* the system wallpaper, so Mission Control and the lock screen match by definition. The wallpaper cache cleanup option sticks around so you can reclaim the space Continuity used before you upgraded.
