...
What's new :
- Fix black screen happening in some scenarios (mostly when waking up from sleep). Many thanks to @Antholife for the fix (https://github.com/AerialScreensaver/Aerial/pull/148)
- Add beta channel for upcoming 4.1 updates
