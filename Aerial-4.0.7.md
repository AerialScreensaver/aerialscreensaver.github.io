Aerial 4. is finally out 🍾 This took a long while, so a massive thanks to all the alpha testers who helped with their testing, bug reports and feedback !
...
What's new :
- Add progress bar for currently playing video in popover
- Fix auto-pause not correctly working on some screen arrangements
- Fix auto-pause not detecting if you changed your screen arrangements
- Fix screensaver per screen selection not working
- For more info on general V4 changes, check : https://aerialscreensaver.github.io/ 
